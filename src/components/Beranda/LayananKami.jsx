    ...
    <div>
      <section className="h-c850">
        ...
        <div className="flex justify-center mt-16 ml-24">
          <div className="w-1/3">
            {/* Card 1 */}
            <div className="shadow-xl w-c347 h-c300">
              <img className="w-full object-cover" src={`/img/FastCleaning.jpg`} alt="Card image"/>
        ...
        <div className="flex justify-center mt-12 ml-24">
          <div className="w-1/3">
            {/* Card 4 */}
            <div className="shadow-xl w-c347 h-c300">
              <img className="w-full object-cover" src={`/img/FastCleaning.jpg`} alt="Card image"/>
