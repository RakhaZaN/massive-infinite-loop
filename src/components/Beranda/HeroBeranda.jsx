    ...
    <div>
      <section style={sectionStyle} className="relative">
        <div className="absolute top-60 ml-20">
          <h1 className="text-5xl font-semibold mb-2 font-nunito">
            Howheal Shoes and Care
          </h1>
          <h1 className="text-5xl font-semibold text-customBlue5 font-nunito">
            Revive your shoes, revive your style
          </h1>
        </div>
        <img
        ...
        >
          ...
          {/* Ganti dengan sumber dan nama file gambar Anda */}
          WhatsApp Care
        </a>
      </section>
    </div>
