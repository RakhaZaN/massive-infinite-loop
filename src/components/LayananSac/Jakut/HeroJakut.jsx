function HeroJakut() {
  ...
  return (
    <div className="h-c542 relative">
      <section
        style={sectionStyle}
        className="bg-hero flex justify-center items-center"
      >
        <div className="text-center">
          <h1 className="text-5xl font-bold mb-2 font-nunito">
            Layanan & Harga Menu
          </h1>
          <h1 className="text-3xl mt-4 font-nunito">
            BERANDA / HALAMAN /{" "}
            <span className="text-customBlue5">LAYANAN & HARGA MENU</span>
          </h1>
        </div>
        <a
          href="https://wa.me/6282214237743"
          target="_blank"
          style={buttonStyle}
      ...
      <div style={boxStyle}>
        <div style={leftBoxStyle}>
          ...
          <img
            className="pb-6"
            src="/img/HowhealLayananSac.png"
            alt="Your Logo"
          />
        </div>
        <div style={rightBoxStyle}>
          {/* Isi dengan teks Anda */}
          <p className="font-nunito font-semibold text-4xl">
            Shoes And Care Jakarta Utara
          </p>
        </div>
      </div>
    </div>
